...
"[project]/services/invoiceService.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function generateInvoicePDF(data) {
    ...
    doc.setFontSize(20);
    doc.setFont('helvetica', 'bold');
    doc.text('PRO-FORMA INVOICE', 210, 20, {
        align: 'right'
    });
    doc.setFontSize(10);
    doc.setFont('helvetica', 'normal');
    doc.text(`Invoice #: ${data.invoiceNumber}`, 210, 27, {
        align: 'right'
    });
    doc.text(`Date: ${data.orderDate.toLocaleDateString('en-GB', {
        day: 'numeric',
        month: 'long',
        year: 'numeric'
    })}`, 210, 32, {
    ...
    doc.text(`${data.totalWeight.toFixed(2)} kg`, 190, summaryY + 7, {
        align: 'right'
    });
    doc.text('Pricing Tier:', 130, summaryY + 12);
    doc.text(data.tier, 190, summaryY + 12, {
        align: 'right'
    });
    // Items Table
    yPos = 90;
    ...
    data.items.forEach((item, index)=>{
        ...
        doc.setTextColor(0, 0, 0);
        doc.setFontSize(10);
        doc.text(`${item.quantity}`, 115, yPos, {
            align: 'center'
        });
        ...
        doc.setFont('helvetica', 'bold');
        doc.text(formatCurrency(item.lineTotal), 185, yPos, {
            align: 'right'
        });
        yPos += 12;
    });
    ...
    doc.text(formatCurrency(data.subtotal), 185, yPos + 3, {
        align: 'right'
    });
    // Payment Terms
    yPos += 20;
    ...
    doc.text('Kerala Fresh Fish | Premium Wholesale Seafood Supplier', 105, 275, {
        align: 'center'
    });
...
"[project]/app/api/submit-order/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$invoiceService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/invoiceService.ts [app-route] (ecmascript)");
;
;
;
;
...
<body style="margin: 0; padding: 0; background-color: #f5f5f5; font-family: Arial, Helvetica, sans-serif;">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f5f5f5; padding: 40px 20px;">
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td style="padding: 8px 0; border-top: 1px solid #dee2e6;">
                                                    ...
                                                    <span style="color: #212529; font-size: 14px; font-weight: 600; float: right;">${new Date().toLocaleDateString('en-GB', {
                    day: 'numeric',
                    month: 'long',
                    year: 'numeric'
                })}</span>
        ...
        `;
                ...
                const invoiceNumber = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$invoiceService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateInvoiceNumber"])();
                const invoiceData = {
                    invoiceNumber,
                    orderDate: new Date(),
                    customer: {
                ...
                const invoicePDF = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$invoiceService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateInvoicePDF"])(invoiceData);
                ...
                await transporter.sendMail({
                    ...
                    attachments: [
                        {
                            filename: 'logo.png',
                            path: __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'logo.png'),
        ...
        if (process.env.META_WHATSAPP_TOKEN && process.env.META_WHATSAPP_PHONE_NUMBER_ID) {
            try {
                ...
                const itemsList = summary.items.map((item)=>`• ${item.product.englishName} - ${item.quantity}kg @ ${formatCurrency(item.price)}/kg = ${formatCurrency(item.lineTotal)}`).join('\n');
...
Please process this order promptly.`;
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].post(whatsappApiUrl, {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            emailSent,
            whatsappSent,
            message: "Order successfully recorded" + (emailSent ? " and email sent" : "") + (whatsappSent ? " and WhatsApp notification sent" : "") + "."
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__34f51634._.js.map